...
class _postapiState extends State<postapi> {
  ...
  Future<bool> addpost(String postname, String desc) async {
  ...
  Column buildColumn() {
    return Column(
      children: [
        ...
        TextFormField(
          controller: desc,
          decoration: InputDecoration(label: Text("descrption")),
        ),
        ElevatedButton(
            onPressed: () {
              setState(() {
                _success = addpost(name.text, desc.text);
              });
            },
            child: Text("save"))
      ],
